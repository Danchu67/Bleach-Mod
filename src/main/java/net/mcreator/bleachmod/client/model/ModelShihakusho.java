...
public class ModelShihakusho<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("bleach_mod", "model_shihakusho"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(32, 32).addBox(-4.0F, 0.0F, 2.0F, 8.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 48)
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(30, 60).addBox(-3.0F, -2.0F, -3.0F, 4.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(40, 46)
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(44, 39).addBox(-1.0F, -2.26F, -3.0F, 5.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(10, 59)
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(58, 0).addBox(-2.0F, 0.0F, 2.0F, 4.0F, 11.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(54, 27)
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(54, 15).addBox(-2.0F, 0.0F, -3.0F, 4.0F, 11.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(50, 53)
