...
public class TestRenderer extends EntityRenderer<TestEntity> {
	private static final ResourceLocation texture = new ResourceLocation("bleach_mod:textures/entities/getsugatentext.png");
	private final ModelGetsugsTenshou model;

	public TestRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new ModelGetsugsTenshou(context.bakeLayer(ModelGetsugsTenshou.LAYER_LOCATION));
	}
